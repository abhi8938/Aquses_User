...
import { updateUserDetails, updatePassword } from '../ApiRequests/UploadData';
        ...
        return (
            ...
            {() => ( 
               ...
               <View style={styles.referButtonContainer}>
                 {this.renderSaveButton(userData.customerId)}
               </View>
           ...
           <View style={styles.referButtonContainer}>
           {this.renderResetButton(userData.customerId)}
               </View>
               </View>
               </View>
               )}
